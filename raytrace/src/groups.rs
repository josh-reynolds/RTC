...
impl Shape for Group {
    ...
    fn intersect(&self, r: Ray) -> Vec<Intersection> {
        ...
        // ray is parallel to side of group
        if equals(a, 0.0) {
            if equals(b, 0.0) {
              // misses side
...
mod tests {
    ...
    #[test]
    fn ray_parallel_to_side_hits_a_group(){
        let c = group();
    ...
    #[test]
    fn intersecting_a_truncated_group(){
        let mut c = group();
        c.minimum = 1.0;
        c.maximum = 2.0;
    ...
    #[test]
    fn default_closed_value_for_groups(){
        let c= group();
    ...
    #[test]
    fn intersecting_caps_of_closed_group(){
        let mut c = group();
        c.minimum = -0.5;
        c.maximum =  0.5;
        c.closed = true;
    ...
    #[test]
    fn normal_vector_on_group_end_caps(){
        let mut c = group();
        c.minimum = 1.0;
        c.maximum = 2.0;
        c.closed = true;
